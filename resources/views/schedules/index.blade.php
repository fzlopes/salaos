                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @if($schedules!=null)
                            @foreach ($schedules as $item)
                                ...
                                @endif
                                        <td> {{$item->hour}} </td>
                                        <td class="uppercase"> {{$item->client}} </td>
                                        <td> {{$item->service}} </td>
                                        <td>
                                            <div class="clearfix">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class=" form-group {{ $errors->has('client_id') ? 'has-error' :'' }}">
                                                    ...
                                                    <br>
                                                    {!! Form::select('client_id', $clients, !empty($schedule->client)?$schedule->client->id:null,  ['class' => 'form-control','placeholder' => 'Selecione o cliente...']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group {{ $errors->has('service_id') ? 'has-error' :'' }}">
                                                    {!! Form::label('agreement_id', 'Serviço *', ['class' => 'control-label']) !!}
                                                    <br>
                                                    {!! Form::select('service_id', $services, !empty($schedule->service)?$schedule->service->id:null,  ['class' => 'form-control','placeholder' => 'Selecione o serviço...']) !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
